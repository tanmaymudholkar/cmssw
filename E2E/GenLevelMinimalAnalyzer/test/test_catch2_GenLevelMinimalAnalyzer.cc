...
static constexpr auto s_tag = "[GenLevelMinimalAnalyzer]";

TEST_CASE("Standard checks of GenLevelMinimalAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("GenLevelMinimalAnalyzer"
