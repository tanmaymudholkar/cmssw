...
# with command line options: Configuration/GenProduction/python/Guns/OctoPi0_e30_m200_ctau0To3_eta0To1p4_pythia8_cfi.py --conditions 102X_upgrade2018_realistic_v15 -n 10 --mc --era Run2_2018 --eventcontent AODSIM --runUnscheduled --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:@fake,RAW2DIGI,L1Reco,RECO --geometry DB:Extended --datatier GEN-SIM-DIGI-RAW-RECO --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(2000) --fileout file:step_GEN2AODSIM.root --python_filename OctoPi0_e30_m200_ctau0To3_eta0To1p4_pythia8_noPU_GEN2AODSIM_cfg.py --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Guns/OctoPi0_e30_m200_ctau0To3_eta0To1p4_pythia8_cfi.py nevts:10'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_GEN2AODSIM.root'),
...
process.generator = cms.EDFilter("Pythia8EGunV2",
    PGunParameters = cms.PSet(
        AddAntiParticle = cms.bool(True),
        MaxCTau = cms.double(3.0),
        MaxE = cms.double(30.0),
        MaxEta = cms.double(1.4),
        MaxMass = cms.double(0.2),
        MaxPhi = cms.double(3.14159265359),
        MinCTau = cms.double(3e-05),
        MinE = cms.double(29.0),
        MinEta = cms.double(-1.4),
        MinMass = cms.double(0.199),
